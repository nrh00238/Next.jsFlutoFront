...
export default function FinalCTA() {
  ...
  return (
    <section className="relative w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-indigo-50/50 via-purple-50/40 to-slate-50/50 dark:from-[#060314] dark:via-[#030308] dark:to-[#030307]">
