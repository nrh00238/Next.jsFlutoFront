...
export default function TrustBanner() {
  return (
    <section className="py-24 sm:py-32 relative w-full px-4 sm:px-6 lg:px-8 overflow-hidden flex flex-col items-center bg-gradient-to-br from-purple-50/50 via-indigo-50/40 to-blue-50/50 dark:from-[#0a0518] dark:via-[#04030f] dark:to-[#030307]">
